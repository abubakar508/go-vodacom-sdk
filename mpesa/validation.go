...
func validateTransactionReference(name, value string) error { return validatePattern(name, value, reTransactionReference) }
func validateThirdPartyConversationID(name, value string) error { return validatePattern(name, value, reThirdPartyConversationID) }
func validateThirdPartyReference(name, value string) error { return validatePattern(name, value, reThirdPartyReference) }
...
func validateTransactionID(name, value string) error { return validatePattern(name, value, reTransactionID) }
func validateMandateID(name, value string) error { return validatePattern(name, value, reMandateID) }
func validateMsisdnToken(name, value string) error { return validatePattern(name, value, reMsisdnToken) }
func validateVoucherCode(name, value string) error { return validatePattern(name, value, reVoucherCode) }
func validateQueryReference(name, value string) error { return validatePattern(name, value, reQueryReference) }
